...
export const CDEK_PICKUP_POINTS: Record<string, CdekPickupPoint[]> = {
  ...
  красноярск: [
    { id: 'KRS-001', label: 'ПВЗ СДЭК · пр-т Мира, 91' },
  ],
  самара: [
    { id: 'SAM-001', label: 'ПВЗ СДЭК · ул. Ленинградская, 40' },
  ],
  уфа: [
    { id: 'UFA-001', label: 'ПВЗ СДЭК · ул. Ленина, 95' },
  ],
  воронеж: [
    { id: 'VRN-001', label: 'ПВЗ СДЭК · пр-т Революции, 47' },
  ],
};
